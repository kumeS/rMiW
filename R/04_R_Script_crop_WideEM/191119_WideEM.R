...
#Argv01 = "/Users/skume/Desktop/ToDo/R_keras_DL/02_DL_seg_Dataset/03_RatLivervNuc_1024x1024_ver190805/6_WideEM_RatLiver_NCMIR_Prev_001_160408"
#Argv01 = "/Users/skume/Desktop/ToDo/R_keras_DL/02_DL_seg_Dataset/00_HumanNB4_Cell_All_ver191119/127/6_WideEM_NB4_127"
...
for( n in 1:length(len1) ){
  ...
  #AAA <- dir()
  #n <-1
  #for(n in 1:length(AAA)){file.rename(AAA[n], paste("WideEM_x1024-R", formatC(n, width = 4, flag = "0"), ".png",sep=""))}

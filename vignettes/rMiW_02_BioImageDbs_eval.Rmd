...
```{r Fig001, out.width = '75%', fig.cap = "keras::fit process: 50 epochs (model_v01.h5)", echo = FALSE, eval=TRUE}
...
```{r Fig002, out.width = '75%', fig.cap = "keras::fit process: 2000 epochs with GPU (model_v02.h5)", echo = FALSE, eval=TRUE}
##Skip execution for this chunk.

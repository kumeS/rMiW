...
ImgClus <- Img2DClustering(x=Img, Cluster = 3, XY=1024)
#Visualize as a gray image
EBImage::display(EBImage::Image(ImgClus), method = "browser")
#Visualize as a color image
rasterMiW(ImgClus)

#Resize 1024x1024 and perform 4 clustering 
ImgClus <- Img2DClustering(x=Img, Cluster = 4, XY=1024)
#Visualize as a color image
rasterMiW(ImgClus)

```

## The clustering with a compressed image of 512x5124px

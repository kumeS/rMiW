...
**Last modified:** `r file.info("rMiW_01_Basic.Rmd")$mtime`<br/>
**Compiled**: `r Sys.time()`
...
```{r Fig005, out.width = '100%', fig.cap = "Results of three clustering with k-means for Mouse01_Kid_x20_z0_RR01.png", echo = FALSE}
##Skip execution for this chunk.

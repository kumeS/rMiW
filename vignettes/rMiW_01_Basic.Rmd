...
#Barplot
barplot()
table(unlist(ImgClus3$Cluster))
```

```{r Fig005, out.width = '100%', fig.cap = "Results of three clustering with k-means for Mouse01_Kid_x20_z0_RR01.png", eval=FALSE, echo = FALSE}
##Skip execution for this chunk.

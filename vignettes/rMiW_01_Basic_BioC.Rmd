...
output:
    BiocStyle::html_document:
        toc_float: false
vignette: >
    %\VignetteIndexEntry{rMiW: 01. BioC}
...
**Last modified:** `r as.POSIXlt(file.info("rMiW_01_Basic_BioC.Rmd")$mtime, format="%Y-%m-%d %H:%M:%S", tz="Japan")`<br/>
...
```{r Fig001, out.width = '75%', fig.cap = "Mouse01_Kid_x20_z0_RR01.png", echo = FALSE, eval=TRUE}
...
#Barplot
barplot(table(ImgClus3$Cluster*ImgClus3$ClusterNumber))
```

```{r Fig005, out.width = '100%', fig.cap = "Results of three clustering with k-means for Mouse01_Kid_x20_z0_RR01.png", eval=TRUE, echo = FALSE}
##Skip execution for this chunk.
